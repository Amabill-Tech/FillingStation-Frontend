        ...
        return(
            <div ref={printTable} style={tableContainer}>
                <div style={tableHead} className='table-head'>
                    ...
                    <div style={column} className='column'>Expense Date</div>
                    <div style={column} className='column'>Expense Name</div>
                    <div style={column} className='column'>Description</div>
                    <div style={column} className='column'>Expense Amount</div>
                </div>
                    ...
                    props.allOutlets.map((data, index) => {
                        return(
                            <div key={index} style={tableHead2}>
                                ...
                                <div style={column2}>{data.expenseName}</div>
                                <div style={column2}>{data.description}</div>
                                <div style={column2}>{data.expenseAmount}</div>
                            </div>
                        )
                    })
                }
