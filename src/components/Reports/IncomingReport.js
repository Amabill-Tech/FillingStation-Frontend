        ...
        return(
            <div ref={printTable} style={tableContainer}>
                <div style={tableHead} className='table-head'>
                    ...
                    <div style={column} className='column'>Destination</div>
                    <div style={column} className='column'>Product</div>
                    <div style={column} className='column'>Quantity</div>
                    <div style={column} className='column'>Product order</div>
                    <div style={column} className='column'>Truck No</div>
                    <div style={column} className='column'>Waybill No</div>
                    <div style={column} className='column'>Divert Status</div>
                </div>
                    ...
                    props.allOutlets.map((data, index) => {
                        return(
                            <div key={index} style={tableHead2}>
                                ...
                                <div style={column2}>{data.depotStation}</div>
                                <div style={column2}>{data.product}</div>
                                <div style={column2}>{data.quantity}</div>
                                <div style={column2}>{data.productOrderID}</div>
                                <div style={column2}>{data.truckNo}</div>
                                <div style={column2}>{data.wayBillNo}</div>
                                <div style={column2}>{data.divertStatus}</div>
                            </div>
                        )
                    })
                }
