...
const PrintSupplyRecords = (props) => {
        ...
        return(
            <div ref={printTable} style={tableContainer}>
                <div style={tableHead} className='table-head'>
                    ...
                    <div style={column} className='column'>Transporter</div>
                    <div style={column} className='column'>Truck No</div>
                    <div style={column} className='column'>Waybill No</div>
                    <div style={column} className='column'>Product Supply</div>
                    <div style={column} className='column'>Quantity</div>
                    <div style={column} className='column'>Shortage/Overage</div>
                </div>
                    ...
                    props.allOutlets.map((data, index) => {
                        return(
                            <div key={index} style={tableHead2}>
                                ...
                                <div style={column2}>{data.date}</div>
                                <div style={column2}>{data.transportationName}</div>
                                ...
                                <div style={column2}>{data.shortage}</div>
                            </div>
                        )
                    })
                }
...
export default PrintSupplyRecords;