        ...
        return(
            <div ref={printTable} style={tableContainer}>
                <div style={tableHead} className='table-head'>
                    ...
                    <div style={column} className='column'>Account Name</div>
                    <div style={column} className='column'>Truck No</div>
                    <div style={column} className='column'>Product</div>
                    <div style={column} className='column'>Litre</div>
                    <div style={column} className='column'>AmountRate</div>
                </div>
                    ...
                    props.allOutlets.map((data, index) => {
                        return(
                            <div key={index} style={tableHead2}>
                                ...
                                <div style={column2}>{data.accountName}</div>
                                <div style={column2}>{data.truckNo}</div>
                                <div style={column2}>{data.productType}</div>
                                <div style={column2}>{data.litre}</div>
                                <div style={column2}>{data.amountRate}</div>
                            </div>
                        )
                    })
                }
