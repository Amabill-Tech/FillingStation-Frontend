        ...
        return(
            <div ref={printTable} style={tableContainer}>
                <div style={tableHead} className='table-head'>
                    ...
                    <div style={column} className='column'>Organisation Name</div>
                    <div style={column} className='column'>Description</div>
                    <div style={column} className='column'>Amount</div>
                    <div style={column} className='column'>Contact Persion</div>
                    ...
                    props.allOutlets.map((data, index) => {
                        return(
                            <div key={index} style={tableHead2}>
                                ...
                                <div style={column2}>{data.organisationalName}</div>
                                <div style={{...column2, color:'green'}}>{data.description}</div>
                                <div style={{...column2, color:'red'}}>{data.amount}</div>
                                <div style={{...column2, color:'red'}}>{data.contactPerson}</div>
