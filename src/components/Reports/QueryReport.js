        ...
        return(
            <div ref={printTable} style={tableContainer}>
                <div style={tableHead} className='table-head'>
                    ...
                    <div style={column} className='column'>Query Title</div>
                    <div style={column} className='column'>Description</div>
                    <div style={column} className='column'>Date Queried</div>
                </div>
                    ...
                    props.allOutlets.map((data, index) => {
                        return(
                            <div key={index} style={tableHead2}>
                                ...
                                <div style={{...column2, color:'green'}}>{data.queryTitle}</div>
                                <div style={{...column2, color:'red'}}>{data.description}</div>
