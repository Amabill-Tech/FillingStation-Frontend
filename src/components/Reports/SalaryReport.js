        ...
        return(
            <div ref={printTable} style={tableContainer}>
                <div style={tableHead} className='table-head'>
                    ...
                    <div style={column} className='column'>Position</div>
                    <div style={column} className='column'>Level</div>
                    <div style={column} className='column'>Salary Range</div>
                </div>
                    ...
                    props.allOutlets.map((data, index) => {
                        return(
                            <div key={index} style={tableHead2}>
                                ...
                                <div style={column2}>{data.position}</div>
                                <div style={{...column2, color:'green'}}>{data.level}</div>
                                <div style={{...column2, color:'red'}}>{data.low_range+' - '+data.high_range}</div>
                            </div>
                        )
                    })
                }
